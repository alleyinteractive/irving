...
* In order to publish a release you will need to create GitHub authentication token (under Settings > Developer settings > Personal access tokens). Once you have your token token, create a `.env` file and assign it to a `GH_TOKEN` environmental variable.
