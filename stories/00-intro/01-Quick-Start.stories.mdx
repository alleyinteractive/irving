...
To scaffold our new application, we'll clone the [create-irving-app](https://github.com/alleyinteractive/create-irving-app) repo into any directory,

`git clone https://github.com/alleyinteractive/create-irving-app my-irving-site`
