...
#### Basic Usage
`${siteTheme('colors.brand.primary')}` returns `#735fea`

Or using the nested value,
`${siteTheme('colors.brand.primary')}` returns `#735fea`

[Utility on Github](https://github.com/alleyinteractive/irving/blob/master/packages/styled/utils/siteTheme.js)
...
export const ContainerWrapper = styled.div`
  border: 1px solid ${siteTheme('colors.brand.secondary')};
