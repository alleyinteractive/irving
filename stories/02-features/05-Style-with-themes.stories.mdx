...
* Theme files containing your styled components definitions _must_ export an object. This can either be a series of named exports or an actual JavaScript object.
