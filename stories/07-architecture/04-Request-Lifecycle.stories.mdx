<Meta title="Architecture|Request Lifecycle" />
...
* [express.js](https://expressjs.com/) handles the request. Note: _all_ requests are handled the same way by express, actual path-based routing is offloaded to your CMS. For more info see the [server docs](https://github.com/alleyinteractive/irving/wiki/Irving%27s-Server)
