...
We're going to create a module for the bottom of `single.json` for a Podcast call to action module.
...
## Add the component to your template
We'll start super simple, by adding `tutorial/podcast` to our template.
