...
## Table of Contents
* [Setup the Theme Map](?path=/docs/tutorial-styling-the-template--page)
* [Add some custom fonts](?path=/docs/tutorial-styling-the-template--page)
* [Style the title](?path=/docs/tutorial-styling-the-template--page)
...
**Finished Product**
<img src="/assets/img/tutorial/03/full.png" style={{maxWidth: "600px", margin: "auto", width: "100%"}} />

## Setup the Theme Map

### Create `themes.js` in the root of your
If it doesn't already exist, create a `themeMap.js` in the root Irving application,
...
```html
<link rel="preconnect" href="https://fonts.gstatic.com"><link href="https://fonts.googleapis.com/css2?family=Gentium+Book+Basic:ital,wght@0,400;0,700;1,400;1,700&family=Open+Sans:ital,wght@0,600;1,600&display=swap" rel="stylesheet">
```
...
<img src="/assets/img/tutorial/03/title.png" style={{maxWidth: "600px", margin: "auto", width: "100%"}} />
...
<img src="/assets/img/tutorial/03/byline-and-timestamp.png" style={{maxWidth: "600px", margin: "auto", width: "100%"}} />
...
<img src="/assets/img/tutorial/03/content.png" style={{maxWidth: "600px", margin: "auto", width: "100%"}} />
...
<img src="/assets/img/tutorial/03/social-sharing.png" style={{maxWidth: "600px", margin: "auto", width: "100%"}} />
