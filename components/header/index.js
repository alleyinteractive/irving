...
const Header extends React.Component ({ homeUrl, children }){
  render(){
    ...
    refGetHeaderSize = header {
      if (header) {
        this.props.getSize(header.getBoundingClientRect());
      }
    };
    ...
    return (
      <>
        ...
        <Headroom
          ...
          ref={refGetHeaderSize} // does this have to be on Header?? Don't think I can set Prop.Types or map here
        >
...
export default withRedux(wrapWithStyles(styles))(Header);
