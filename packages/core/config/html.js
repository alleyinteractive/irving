export const richText = {
  allowedTags: [
    ...
    'h4', 'h5', 'h6', 'header', 'hgroup', 'hr', 'i', 'iframe', 'img', 'ins',
    'input', 'kbd', 'label', 'legend', 'li', 'link', 'map', 'mark', 'menu',
    'nav', 'p', 'pre', 'q', 's', 'samp', 'span', 'section', 'small', 'strike',
  ...
  allowedAttributes: {
    ...
    ins: ['datetime', 'cite'],
    input: ['accept','alt','autocomplete','autofocus','capture','checked',
